...
5. **Adicione Variáveis de Ambiente:**
   ...
   SUPABASE_SERVICE_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImppbHd6Znhscm9lbnhzZHlqaHNkIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2NDg1NDg2NywiZXhwIjoyMDgwNDMwODY3fQ.wXrFmjta0mFGPwvu3jEAmH9TuqRGna6HYPiUKoPUT9I
   JWT_SECRET=biblioteca-saquarema-secret-key-2025-super-segura
   VITE_API_URL=/api
   ```
   
   ⚠️ **IMPORTANTE - Chave SERVICE_KEY correta:**
   ...
   - A SERVICE_KEY termina com `...wXrFmjta0mFGPwvu3jEAmH9TuqRGna6HYPiUKoPUT9I`
   - Necessária para operações de importação (bypass RLS)
   - ⚠️ Se copiar do Supabase Dashboard, use a service_role key completa!
